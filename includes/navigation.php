<nav class="row col-12 navbar navbar-light navbar-expand-md m-0 p-0 pb-2 fixed-top gradient-background">
            ...
            <li class="nav-item mt-1 mr-lg-4">
                <a class="nav-link text-white" href="HomePage.php" tabindex="-1" aria-disabled="true">Home</a>
            </li>
            <li class="nav-item mt-1 mr-lg-4">
                <a class="nav-link text-white" href="categories.php" tabindex="-1" aria-disabled="true">Categories</a>
            </li>
            <li class="nav-item mt-1 mr-lg-4">
                <a class="nav-link text-white" href="contact.php" tabindex="-1" aria-disabled="true">Contact</a>
            </li>
            <li class="nav-item mt-1 mr-lg-4">
                <a class="nav-link text-white" href="about.php" tabindex="-1" aria-disabled="true">About</a>
            </li>
        </ul>
    </div>
</nav>